      ...
      <div className="alfaCont">
        <div className="uwuClaim mobileUwuClaim">
          ...
          <a>
            ...
            <div className="claimButton hide" id="ClaimM">
              Claim Rewards
            </div>
          </a>
        </div>
          ...
          <div className="leftBoxContent">
            ...
            <div className="statisticList ">
              <div className="statBox tooltip">
                <div className="right hideMob">
                  <p>
                    Amount of holder that have their weirdos staked at the
                    Underworld!
                  </p>
                  <i></i>
                </div>
                ...
                <div>Holders at the Underworld</div>
              </div>

              <div className="statBox tooltip">
                <div className="right hideMob">
                  <p>
                    All the weirdos without bonus traits earn base $UWU rewards
                    (1 every 24h)
                  </p>
                  <i></i>
                </div>
                ...
                <div>Weirdos without Bonus</div>
              </div>
              <div className="statBox tooltip">
                <div className="right hideMob">
                  <p>
                    Weirdos with one bonus trait get +50% extra rewards (1.5
                    $UWU every 24h)
                  </p>
                  <i></i>
                </div>
                ...
                <div>Weirdos with x1.5 Bonus</div>
              </div>
              <div className="statBox tooltip">
                <div className="right hideMob">
                  <p>
                    Non-common weirdos with two bonus traits get +200% extra
                    rewards (3 $UWU every 24h)
                  </p>
                  <i></i>
                </div>
                ...
                <div>Weirdos with x3 Bonus</div>
              </div>
              <div className="statBox SBLast tooltip">
                <div className="right hideMob">
                  <p>
                    Rarest weirdos with three bonus traits get +900% extra
                    rewards (10 $UWU every 24h)
                  </p>
                  <i></i>
                </div>
                ...
                <div>Weirdos with x10 Bonus</div>
              </div>
            </div>
            <div className="weirdTrio tooltip">
              ...
              <div className="bottom">
                <p>
                  These are the bonus traits of the week, you can see the
                  bonuses for having one or more of this traits at our FAQ
                  section.
                </p>
                <i></i>
              </div>
        ...
        <div className="rightBox">
          <div className="rightBoxContent" id="rightBoxContent">
            ...
            <div id="Your_WeirdosD">
              {" "}
              {NftsInStake.length}/ {(Nfts.length + Nfts2.length )+ NftsInStake.length}
            </div>
